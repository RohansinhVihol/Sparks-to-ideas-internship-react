    ...
    <div className="bg-gray-900 min-h-screen p-8">
      ...
      <div className="flex justify-center gap-12 mb-12">
        ...
        <div className="flex flex-col items-center">
          ...
          />
          <p className="mt-4 text-white text-2xl font-semibold">BMW M1 </p>
        </div>-
        ...
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-60 h-60 object-cover rounded-full shadow-lg"
          />
          <p className="mt-4 text-white text-2xl font-semibold">BMW M2</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-60 h-60 object-cover rounded-full shadow-lg"
          />
          <p className="mt-4 text-white text-2xl font-semibold">BMW M3</p>
        </div>
      </div>
      ...
      <div className="flex justify-center gap-12">
        ...
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-60 h-60 object-cover rounded-full shadow-lg"
          />
          <p className="mt-4 text-white text-2xl font-semibold">BMW M4</p>
        </div>
        ...
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-60 h-60 object-cover rounded-full shadow-lg"
          />
          <p className="mt-4 text-white text-2xl font-semibold">BMW M5</p>
        </div>
      </div>
    </div>
  );
